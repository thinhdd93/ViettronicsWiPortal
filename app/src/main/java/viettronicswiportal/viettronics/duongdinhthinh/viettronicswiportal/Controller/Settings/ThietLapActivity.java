...
public class ThietLapActivity extends AppCompatActivity {
    ...
    private ImageView imgDanhSachNguoiDung;
    private TextView txtDanhSachNguoiDung;
    ...
    private void addEvents() {
        ...
        txtDanhSachNguoiDung.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DanhSachNguoiDung();
            }
    ...
    private void DanhSachNguoiDung() {
        Intent intent = new Intent(ThietLapActivity.this, DanhSachNguoiDungActivity.class);
        startActivity(intent);
    }

    private void addControls() {
        imgDanhSachNguoiDung = (ImageView) findViewById(R.id.thietlap_img_DanhSachNguoiDung);
        txtDanhSachNguoiDung = (TextView) findViewById(R.id.thietlap_txt_DanhSachNguoiDung);
